...
class BaseUnit extends Unit {
	...
	public static function getRequest(?array $body) {
		...
		return new Request($url, null, null, null, null, null, 'GET', null, null, function () use ($bodyJson) {return $bodyJson;});
	}
	 ...
	 */
	protected function getAppRequestParameters(\Nette\Application\Request $appRequest) {
		return $appRequest->getParameters();
	}
